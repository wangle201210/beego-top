...
export const locales = [{"code":"en","iso":"en-US","file":"en-US.js","name":"English"},{"code":"ch","iso":"ch-CH","file":"ch-CH.js","name":"中文"}]
export const defaultLocale = 'ch'
...
export const localeCodes = ["en","ch"]
